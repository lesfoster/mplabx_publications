 ...
 * Author: llf
 *
 * Created on July 7, 2024, 12:50 PM
 */
...
/**
 * Waveform input will be into the RA2 pin.
 */
...
/**
 * Microsecond level delay with T0. May be unnecessary here,
 * but gives assurance of which timer is being used for this
 */
